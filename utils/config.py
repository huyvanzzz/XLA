...
DEFAULT_CONFIG = {
    ...
    "augmentation": {
        ...
        "min_scale": 0.85,
        "max_scale": 1.15,
        "copy_paste_prob": 0.18,
        "copy_paste_max_objects": 2,
        "copy_paste_classes": ["chair", "cat", "dog"],
        "copy_paste_min_box": 8.0,
        "copy_paste_scale_min": 0.75,
        "copy_paste_scale_max": 1.15,
        "close_copy_paste_epoch": 50,
